...
(function () {
	...
	d.SVGRenderer = d.Class({
		...
		path: function (a, b) {
			let img = "";
			if (b.indexOf("dragIconRoundBig") !== -1) {
				img = "dragIconRoundBig";
			} else if (b.indexOf("lens") !== -1) {
				img = "lens";
			}
			a.node.setAttributeNS(
				d.SVG_XLINK,
				"xlink:href",
				`https://demo.dashboardpack.com/admindek-html/files/assets/pages/widget/amchart/images/${img}.svg`
			);
		},
